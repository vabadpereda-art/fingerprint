...
elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
  ...
  option(FORCE_WIN_STATIC_RUNTIME "Build NFIQ2 with the static MSVC runtime (/MT)" OFF)

  # Rust's x86_64-pc-windows-msvc target uses the dynamic MSVC runtime (/MD)
  # by default. Keep the bundled CMake projects on /MD unless static CRT is
  # explicitly requested; otherwise static libraries from the same superbuild can
  # be linked with incompatible RuntimeLibrary settings (LNK2038).
